...
set destDir=.\downloads\newYorkNoir_authorMaterials_v3latest
...
del ".\downloads\newYorkNoir_authorMaterials_v3latest.zip"
del ".\downloads\newYorkNoir_materials_v3latest.zip"
del ".\downloads\newYorkNoir_rulesEtc.zip"

"C:\Program Files\7-Zip\7z.exe" a ".\downloads\newYorkNoir_authorMaterials_v3latest.zip" ".\downloads\newYorkNoir_authorMaterials_v3latest"
"C:\Program Files\7-Zip\7z.exe" a ".\downloads\newYorkNoir_Materials_v3latest.zip" ".\downloads\newYorkNoir_Materials_v3latest"
